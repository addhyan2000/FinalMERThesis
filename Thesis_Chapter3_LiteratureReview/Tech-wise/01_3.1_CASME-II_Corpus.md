...
The field's response has been to group by affective valence. The convention originates with SMIC, which was released with exactly three classes — positive, negative, surprise [@liX2013] — and it was formalised for cross-corpus work by the Second Facial Micro-Expression Grand Challenge (MEGC 2019) [@see2019], which defines:
