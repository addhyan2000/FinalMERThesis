...
*Table 3.5 — The spontaneous micro-expression corpora, compiled from Yan et al. [@yan2014] (Table 1), Davison et al. [@davison2018] (Table 1), Li et al. [@liX2013] and Qu et al. [@qu2016].*
...
| 156 clips total (3.1.7a) | Preference for **parameter-free or low-parameter components** wherever a choice exists — motivating the use of SimAM [@yang2021], which adds zero learnable parameters — and for shallow rather than deep spatial backbones, following the model-shrinking argument of Xia et al. [@xia2020b] | Ch. 4 |
