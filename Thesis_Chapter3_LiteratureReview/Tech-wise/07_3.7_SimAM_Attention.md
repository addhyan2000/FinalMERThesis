...
| SimAM requires a feature map to attend over [@yang2021] | Creates the architectural dependency that prunes 4 of the 16 factorial cells (§3.1.3): attention without a backbone is undefined |
