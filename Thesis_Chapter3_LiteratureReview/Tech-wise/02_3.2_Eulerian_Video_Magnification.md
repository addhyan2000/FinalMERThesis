...
Bai et al. [@bai2021] give the clearest account in the review corpus of the two variants and their difference.
...
The best configuration of their full framework — magnification, TIM10 and HIGO — reaches 67.21 % on CASME II and 68.29 % on SMIC-HS under LOSO, which they show to be competitive with or better than the contemporaneous state of the art. Li et al. [@liX2018] flag a problem in that comparison: several published CASME II figures, including the 63.41 % baseline of Yan et al. [@yan2014], were obtained under **leave-one-sample-out** validation, "which is much easier" than the leave-one-subject-out protocol used here (§3.1.4).
...
**There is no principled procedure for choosing α.** Every value in the corpus is obtained empirically — by exhaustive sweep [@liX2018] or by citation of a prior sweep [@liY2018; @liY2021]. No paper offers a way to select α from properties of the data.
