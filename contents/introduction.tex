...
\begin{itemize}
	\item \textbf{Chapter 1 --- Introduction} introduces the phenomenon and the practical difficulty that motivates the work, states the question the thesis asks, and outlines the design assembled to answer it.
