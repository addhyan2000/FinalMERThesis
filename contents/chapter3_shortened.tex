...
\textbf{Participants and apparatus.} Thirty-five participants were recruited, mean age 22.03 years (SD = 1.60), and watched high-valence video episodes pre-rated by an independent panel of twenty raters, under instruction to suppress all facial movement. Recording sustained \textbf{200 fps} at 640~$\times$~480 with no inter-frame compression, under four LED lamps with umbrella reflectors giving steady flicker-free illumination which is a deliberate correction of the artefacts observed in SMIC. The facial region is approximately \textbf{280 $\times$ 340 pixels}, over three times CASME's facial area and roughly double SMIC's.

\textbf{Selection and annotation.} From nearly 3,000 elicited movements a small subset was retained, very subtle movements being discarded because their onset and offset frames could not be reliably located. Each retained sample carries onset and offset frame indices, Facial Action Coding System (FACS) action-unit labels from two independent coders with disagreements arbitrated by discussion, and an emotion label. Yan et al.~\cite{yan2014} argue against forcing spontaneous micro-expressions into the six basic categories, since a single action unit is frequently ambiguous, like AU4 (brow lowerer) may indicate disgust, anger, attention or tension,and assign the emotion label from a \textit{combination} of the coded AUs, the participant's self-report, and the emotional content of the eliciting episode.
...
\textbf{Third, the baseline's sensitivity to a purely descriptive hyper-parameter is itself informative.} Accuracy moves by several points across the radius sweep with no change to the data, the split or the classifier. Where effect sizes of that magnitude arise from descriptor settings, differences of similar magnitude between architectures cannot be interpreted without a variance estimate which is a limitation this thesis inherits and declares.
